    ...
    def execute(self, course_title: str) -> str:
        ...
        try:
            ...
            for course in all_courses:
                ...
                if (
                    course_title_lower in course_name
                    or course_name in course_title_lower
                ):
    ...
    def _format_course_outline(self, course_metadata: Dict[str, Any]) -> str:
        ...
        if lessons:
            ...
            if lesson_numbers:
                ...
                if missing_lessons:
                    outline.append(
                        f"*Note: Missing lessons: {sorted(missing_lessons)}*"
                    )
                    outline.append("")
        ...
        if lessons:
            ...
            for lesson in sorted_lessons:
                ...
                if lesson_link:
                    outline.append(
                        f"- Lesson {lesson_num}: {lesson_title} - [{lesson_link}]({lesson_link})"
                    )
                else:
            ...
            if hasattr(tool, "last_sources") and tool.last_sources:
                ...
                for source in tool.last_sources:
                    if isinstance(source, dict):
                        ...
                        sources.append({"text": str(source), "url": None})
                return sources
        return []
